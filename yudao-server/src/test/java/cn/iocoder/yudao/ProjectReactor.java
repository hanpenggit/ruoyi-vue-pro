...
public class ProjectReactor {
    ...
    private static final String TITLE = "柠檬管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.peng.boot";
        String artifactIdNew = "lemon";
        String packageNameNew = "cn.peng.lemon";
        String titleNew = "柠檬管理系统";
//        String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = "/Users/hanpeng/Documents/project/lemon/lemon-vue"; // 一键改名后，“新”项目所在的目录
