...
public class BpmProcessInstancePageItemRespVO {
    ...
    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "柠檬")
    private String name;
    ...
    public static class Task {
        ...
        @Schema(description = "任务名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "柠檬")
        private String name;
