...
public class DesensitizeTest extends BaseMockitoUnitTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("柠檬源码");
        ...
        desensitizeDemo.setRegex("你好，我是柠檬源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("柠檬源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "柠檬源码", replacer = "*")
